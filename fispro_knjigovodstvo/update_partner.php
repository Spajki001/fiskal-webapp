...
$stmt->bind_param('sssssiisssssi', $naziv, $adresa, $oib, $pdv, $iznos_naknade, $firma_id, $referent_id, $vrsta_knjigovodstva, $placa, $drugi_dohodak, $dodatne_usluge, $fakturira, $id);
